...
and GCP offer for running docker containers.
...
git clone git@github.com:Coko-Foundation/xsweet-microservice.git
cd xsweet
...
open a GitHub issue in [Kotahi's GitHub repo](https://github.com/eLifePathways/Kotahi/).
